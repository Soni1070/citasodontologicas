        ...
        <div class="row">
                ...
                <div class="form-group mb-3">
                    ...
                    <select class="form-control" id="ubicacion" name="ubicacion" required>
                        ...
                        <option value="piso1" {{ old('ubicacion', $consultorio->ubicacion) == 'piso1' ? 'selected' : '' }}>Piso 1</option>
                        <option value="piso2" {{ old('ubicacion', $consultorio->ubicacion) == 'piso2' ? 'selected' : '' }}>Piso 2</option>
                        <option value="piso3" {{ old('ubicacion', $consultorio->ubicacion) == 'piso3' ? 'selected' : '' }}>Piso 3</option>
                    </select>
                    @error ('ubicacion')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
