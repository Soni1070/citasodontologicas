    ...
    <div class="col-md-12">
        ...
        <div class="row">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" value="{{ old('nombres') }}" class="form-control" id="name" name="nombres" required>
                    @error ('name')
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" value="{{ old('apellidos') }}" class="form-control" id="apellido" name="apellidos" required>
                    @error ('apellidos')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
            ...
            <div class="row">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" value="{{ old('numero_seguro') }}" class="form-control" id="numero_seguro" name="numero_seguro" required>
                    @error ('numero_seguro')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
            ...
            <div class="col-md-4">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="email" value="{{ old('correo') }}" class="form-control" id="email" name="correo" required>
                    @error ('correo')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" value="{{ old('direccion') }}" class="form-control" id="direccion" name="direccion" required>
                    @error ('direccion')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <option value="" disabled selected>Seleccione grupo sanguíneo</option>
                ...
                <div class="col-md-4">
                  ...
                  <div class="form-group mb-3">
                      ...
                      <input type="text" value="{{ old('contacto_emergencia') }}" class="form-control" id="contacto_emergencia" name="contacto_emergencia">
